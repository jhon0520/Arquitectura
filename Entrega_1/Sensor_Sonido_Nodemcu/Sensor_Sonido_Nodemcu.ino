...
const char *ssid = "Qwerty";  //ENTER YOUR WIFI SETTINGS
const char *password = "asdqwe123";

//Web/Server address to read/write from 
const char *host = "localhost:3000/sala";   //https://circuits4you.com website or IP address of server
...
void postrequest() {
  ...
  http.begin("localhost:3000/sala");              //Specify request destination
